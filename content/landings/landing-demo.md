...
sections:
  - type: hero
    ...
    subheading: "Tu <span class='golden-text'>MEDICINA CUÁNTICA</span> en tu casa."
  ...
  - type: equipos
    ...
    - name: "SER AMOR"
      ...
      details:
        ...
        - "Spark Gap externo: Con electrodos de tugusteno puro de 6mm. Recalibración externa de la potencia y frecuencia (vida útil prolongada)."
      ...
      accessories:
        ...
        - name: "Lámpara roja de alta frecuencia"
          icon: "/assets/images/accesorios/Amor/Lámpara roja de alta frecuencia - SER AMOR.webp"
        - name: "3 Spark Gap. Electrodos tugusteno puros de 6mm"
          icon: "/assets/images/accesorios/Amor/Spar gap o salto de chispa del SER AMOR.webp"
    ...
    - name: "SER ORIGEN ∞"
      ...
      price: "$1.800 USD"
      details:
        - "Diseño: caja de madera blanca con su tapa transparente, de 24cm x 44cm x 15cm; peso 4kg. Regilla exterior cubre ventilación con diseño de Geometría sagrada (Flor de la vida)."
        - "Alimentación: 110-220v para fuente de 12v/15 A - (50-60 hz)"
        - "Fuente de poder: ZVS + flyback sintonizado en resonancia, para generar 30.000 voltios."
        - "Consumo de energía: 0.18 kilovatios."
        - "Banco de Capacitores: de alta tensión 4,7 nf/6000v (dispuestos para filtrar el flujo de la energía caliente de 30.000 voltios (+ y -) en energía fría, las cuales se encuentran en la bobina D'Arsonval produciendose la energía de punto 0 radiante y magnética."
      ...
      accessories:
        - name: "Bobina Oudin Grande"
          icon: "/assets/images/accesorios/Amor/Bobina Mediana.webp"
        - name: "Bobina Pancake Radiante"
          icon: "/assets/images/accesorios/Origen/pancake azul - radiante 20cm.jpeg"
        - name: "Bobina Pancake Magnética"
          icon: "/assets/images/accesorios/Origen/pancake roja - magnetica 24cm.jpeg"
        - name: "Manguitos"
    ...
    - name: "SER ORIGEN"
      ...
      description: "Dispositivo de 3 Spark Gap o acelerador de partículas. Diseño rígido portátil con electrodos de tugusteno puros de 4mm. Recalibración externa."
      price: "$1.360 USD"
      details:
      ...
      accessories:
        ...
        - name: "3 Spark Gap. Electrodos tugusteno puro de 4mm"
          icon: "/assets/images/accesorios/Origen/Spar gap del Ser origen caja plástica.webp"
    ...
    - name: "SER ESENCIA"
      ...
      description: "Dispositivo de 1 Spark Gap o acelerador de partículas. Diseño rígido portátil con electrodos de tugusteno puros de 3mm."
      price: "$750 USD"
      details:
        - "Diseño: caja rústica de PVC (modelo caja herramientas) con manija de facil transportación, dimensiones: 25cm x 47cm x 20cm; peso 3kg."
        - "Alimentación: 110-220v para fuente de 12v/15 A - (50-60 hz). (Consultar opción de conexión 12v directo a batería)"
  ...
  - type: about
    ...
    story2: >
      En su taller móvil recorriendo Argentina siempre cuida y respeta su ambiente de creación; el mismo es armónico y amoroso. Si en el día se presenta una vibración inferior a la misma, pues deja de construir y retoma cuando el clima de su lugar vuelve a estar en sintonía con frecuencia elevada.


    differential: "Su misión acercar la energia escalar a cada hogar de Argentina y el mundo para que todos reciban y conecten con su automedicina."
  ...
  - type: footer
    ...
    legal: "Nota legal: La empresa no se responsabiliza por el mal uso."
    links:
     - text: Inicio
       url: "#hero"
     - text: Beneficios
